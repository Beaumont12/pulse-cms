...
export default function SuperAdminManageUsers() {
    ...
    const handleTabChange = (event, newValue) => {
        ...
        if (newValue === 0)
            navigate("/super_admin/SuperAdminManageUsers", { replace: true });
        if (newValue === 1)
            navigate("/super_admin/SuperAdminAddUser", { replace: true });
        if (newValue === 2)
            navigate("/super_admin/SuperAdminAccountRecovery", {
                replace: true,
            });
    };
    ...
    useEffect(() => {
        ...
        onValue(usersRef, (snapshot) => {
            ...
            if (data) {
                const loadedUsers = Object.entries(data).map(
