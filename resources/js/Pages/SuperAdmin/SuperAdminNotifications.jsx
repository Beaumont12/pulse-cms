...
const SuperAdminNotifications = () => {
  ...
  const getCurrentCategory = () => {
    if (location.pathname.includes("SuperAdminNoticeNotification")) return 1;
    if (location.pathname.includes("SuperAdminSystemMessages")) return 2;
    return 0;
  };
  ...
  const handleCategoryChange = (e, newVal) => {
    setCategory(newVal);
    if (newVal === 0) navigate("/super_admin/SuperAdminNotifications", { replace: true });
    if (newVal === 1)
      navigate("/super_admin/SuperAdminNoticeNotification", { replace: true });
    if (newVal === 2)
      navigate("/super_admin/SuperAdminSystemMessages", { replace: true });
  };
