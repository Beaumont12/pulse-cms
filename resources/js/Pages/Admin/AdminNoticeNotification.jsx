...
const AdminNoticeNotification = () => {
  ...
  const handleCategoryChange = (e, newVal) => {
    setCategory(newVal);
    if (newVal === 0) navigate("/admin/AdminNotifications", { replace: true });
    if (newVal === 1)
      navigate("/admin/AdminNoticeNotification", { replace: true });
    if (newVal === 2)
      navigate("/admin/AdminSystemMessages", { replace: true });
  };
